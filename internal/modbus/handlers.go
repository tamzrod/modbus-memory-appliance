...
func handleConn(conn net.Conn, resolve MemoryResolver) {
	...
	for {
		...
		// 🔑 THIS is the only routing logic now
		mem := resolve(mbap.UnitID, pdu.Function)

		if mem == nil {
			resp := exception(pdu.Function, 0x02) // Illegal Device Address
...
func handlePDU(pdu PDU, mem *core.Memory) []byte {
	...
	case 0x04: // Read Input Registers
		...
		if err != nil {
			return exception(pdu.Function, 0x02) // Illegal Data Address
		}
	...
	case 0x05: // Write Single Coil
		...
		case 0x0000:
			b = false
		default:
			return exception(pdu.Function, 0x03) // Illegal Data Value
		}
